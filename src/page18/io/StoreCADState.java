...
abstract class Shape implements Serializable {
    ...
    public String toString() {
        return getClass() + "color[" + getColor() + "] xPos[" + xPos + "] dim[" + dimension + "]\n";
    }
...
public class StoreCADState {
    public static void main(String[] args) throws IOException {
        ArrayList<Class<? extends Shape>> shapeTypes = new ArrayList<Class<? extends Shape>>();
        ...
        ObjectOutputStream out = new ObjectOutputStream(new FileOutputStream("tmp/CADState.out"));
